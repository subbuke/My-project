...
const Dashboard = () => {
    return (
        <div>
            ...
            <h1 className="text-center font-black text-2xl">Foundation</h1>
            <p className="m-5"> On 13 September 2007,[25] following India's victory at the 2007 T20 World Cup,[26] the BCCI announced a franchise based Twenty20 cricket competition known as the Indian Premier League. The inaugural season was scheduled to start in April 2008, commencing with a "high-profile ceremony" in New Delhi. BCCI Vice-president Lalit Modi, who led the IPL initiative, provided details of the tournament, including its format, prize money, franchise revenue system, and squad composition rules. The league, to be managed by a seven-man governing council, would also serve as the qualifying mechanism for that year's Champions League Twenty20.[25]
  ...
  <table className="w-full text-sm text-left rtl:text-right text-gray-200 dark:text-gray-400">
    ...
    <tbody>
      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        <td className="px-6 py-4">	Joburg Super Kings</td>
        <td className="px-6 py-4"></td>
        <td className="px-6 py-4"></td>
      </tr>
      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        <td className="px-6 py-4"></td>
        <td className="px-6 py-4">Pretoria Capitals</td>
        <td className="px-6 py-4">Dubai Capitals</td>
        <td className="px-6 py-4"></td>
      </tr>
      ...
      <tr className="bg-white dark:bg-gray-800">
        ...
        <td className="px-6 py-4">Trinbago Knight Riders	</td>
        <td className="px-6 py-4"></td>
        <td className="px-6 py-4">Abu Dhabi Knight Riders</td>
        <td className="px-6 py-4">Los Angeles Knight Riders</td>
      </tr>
      <tr className="bg-white dark:bg-gray-800">
        <th
          scope="row"
        ...
        <td className="px-6 py-4"></td>
        <td className="px-6 py-4">	Durban's Super Giant</td>
        <td className="px-6 py-4"></td>
        <td className="px-6 py-4"></td>
      </tr>
      <tr className="bg-white dark:bg-gray-800">
        ...
        <td className="px-6 py-4"></td>
        <td className="px-6 py-4">	MI Cape Town</td>
        <td className="px-6 py-4">MI Emirates</td>
        <td className="px-6 py-4">MI New York</td>
      </tr>
      <tr className="bg-white dark:bg-gray-800">
        <th
          scope="row"
        ...
        <td className="px-6 py-4">Saint Lucia Kings</td>
        <td className="px-6 py-4"></td>
        <td className="px-6 py-4"></td>
        <td className="px-6 py-4"></td>
      </tr>
